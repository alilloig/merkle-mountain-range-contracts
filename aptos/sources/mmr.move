module mmr::mmr{
    ...
    public fun verify(proof: &Proof, data: vector<u8>): bool {
        ...
        let node_hash = mmr_utils::hash_with_integer(proof.position, vector::singleton(data));
    ...
    fun new(ctx: &mut TxContext): MMR {
        MMR {
            id: object::new(ctx),
            root: aptos_hash::blake2b_256((0 as u64).to_string().as_bytes()),
    ...
    fun append_leaf(mmr: &mut MMR, leaf_data: vector<u8>) {
        ...
        let node_position = mmr.get_size() + 1;
